...
export default function AttractionsPage({ params }) {
  ...
  const fetchAttractions = async () => {
    try {
      const response = await fetch(`/api/locations/${params.locationId}/attractions`);
  ...
  const proceedToActivities = () => {
    ...
    router.push(`/locations/${params.locationId}/attractions/activities?attractions=${attractionIds}`);
  };
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-3 text-sm text-gray-500">
                        {attraction.duration && (
                          <span>⏱️ {attraction.duration}h</span>
                        )}
                        {attraction.price && (
